	...
	public static void main(String[] args){
		...
		while(true){
			...
			switch(option){
				...
				case "3":
					while(true){
						System.out.println("请输入要删除教师的教师号或者输入【break】返回上一级目录");
				...
				case "4":
					while(true){
						System.out.println("请输教师号或者输入【break】返回上一级目录");
						String idStr = sc.nextLine();
						if(idStr.equals("break")){
							break;
						}
				...
				case "5"://修改
					while(true){
						System.out.println("请输入要修改教师的教师号或者输入【break】返回上一级目录");
						String idStr = sc.nextLine();
						if(idStr.equals("break")){
							break;//跳出当前循环，返回主菜单
						}
